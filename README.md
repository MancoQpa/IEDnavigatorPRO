...
**🇪🇸 Español** · [🇬🇧 English](README.en.md) · [🇨🇳 中文](README.zh.md) · [🇧🇷 Português](README.pt.md) · [🇸🇦 العربية](README.ar.md)
...
Equipos reales contra los que se ejercitó la herramienta, con lo que se verificó en cada uno.
Los nombres se usan para identificar el producto (uso referencial): no implican compatibilidad
declarada, homologación ni respaldo de ningún fabricante.
