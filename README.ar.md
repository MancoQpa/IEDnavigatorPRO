...
| --- | --- |
| Siemens SIPROTEC 5 | اكتشاف النموذج، و**تنفيذ أمر SBO بأمان معزَّز ميدانيًا** مع التحقق من الوضعية |
...
| Efacec | اكتشاف النموذج |
| TPUS420 | اكتشاف النموذج |
...
الأداء الوظيفي لا لإطلاق ادعاءات حول الأداء.
