...
/**
 * Fase 7: Extrae la sección CONNECTION MANAGEMENT de IEDExplorerApp.
...
class ConnectionManager {
    ...
    interface Context {
        ...
        // UI callbacks (implemented by IEDExplorerApp)
        ...
        // SCL parsing (delegates to IEDExplorerApp.parseGoCBsFromScl)
    ...
    // ─── Getters for fields migrated out of IEDExplorerApp ───────────────────────────
    ...
    // ─── Public API (called from IEDExplorerApp) ──────────────────────────────────────
    ...
    void handleDisconnect() {  // F26: package-private so IEDExplorerApp can delegate
